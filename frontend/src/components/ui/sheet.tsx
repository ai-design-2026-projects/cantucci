 ...
 *
 * @param side - Which edge to slide from: top, bottom, left, right.
 */
...
/**
 * Sheet header section with title and optional description.
 */
...
/**
 * Sheet footer section — typically holds action buttons.
 */
...
/**
 * Sheet description — muted secondary text below the title.
 */
