...
embedded catalogue, the components that make up the conversational loop and the lifecycle of a single
turn.
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{Web frontend}: surfaces the entire human-facing experience, from starting and replaying conversations to inspecting clusters and their member films, visualising and navigating the snapshot graph, and, for administrators, an evaluation lab that reviews run metrics, judge scores, and full transcripts;
