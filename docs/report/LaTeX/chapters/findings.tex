...
\begin{description}[leftmargin=1.4em,style=nextline]
  ...
  \item[F1: The explanation agent explains the \emph{wrong film} about half the time
    ...
    43 ($48\%$) answered about a different title: a question about \emph{The Graduate} was
    answered with ``A Real Pain'', and one about \emph{Free Guy} with ``Miss Kobayashi's Dragon
    Maid''. This systematic grounding failure is the hard number behind the lowest judge score in
  ...
  \item[F9: Cluster labels concatenate and bloat with drill-down depth
    ...
    renaming, yielding names such as \textsf{Biting Asian Romantic Comedies Family Fantasy
    Comedies}. Depth compounds the problem rather than refining it.
